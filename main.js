...
function start() {
  ...
  var x = setInterval(function () {
    ...
    if (distance <= 0) {
      clearInterval(x);
      document.getElementById("container").innerHTML = "<h1>Năm mới chúc anh vui vẻ tràn ngập hạnh phúc và sớm thành công nhé <br> <span>Mãi thương anh trong lòng</span> </h1>";
